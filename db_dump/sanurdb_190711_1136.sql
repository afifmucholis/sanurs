...
--
-- Host: localhost
-- Generation Time: Jul 19, 2011 at 12:36 PM
...
INSERT INTO `education` (`id`, `user_id`, `level_id`, `graduate_year`, `school`, `major_id`, `minor`) VALUES
(5, 2, 3, 2012, 'ITB', 1, 'None'),
(4, 2, 1, 2008, 'SMAN 2 Jombang', 0, 'None');
