<div id="content_about_top">
    ...
    <div id="about_photo_deskripsi">
        <?php echo br(13); ?>
        <p>Misi : Menciptakan suasana yang kondusif bagi komunitas untuk belajar terus-menerus.Menciptakan suasana yang kondusif bagi komunitas untuk belajar terus-menerus.</p>
    </div>
...
<div id="content_about_wrap">
    ...
    <div id="content_about_right">
        <img src="<?php echo base_url() . 'res/desain/serviam-logo.png' ?>" />
    </div>
</div>
<div class="clearboth"></div>