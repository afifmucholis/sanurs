...
class Alumni extends CI_Model{
    ...
    */
    function addAlumni($options = array()) {
        ...
        $options = $this->_default(array($this->is_registered => 0), $options);
     ...
     * name             field kriteria name untuk klausa where
     * birthdate        field kriteria birthdate untuk klausa where
